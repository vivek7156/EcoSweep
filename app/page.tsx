...
import { ArrowRight, Sprout, Recycle, Users, HandCoins, MapPin, ChevronRight } from 'lucide-react'
    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      ...
      <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <ImpactCard title="Tokens Earned" value={impactData.tokensEarned.toString()} icon={HandCoins} />
          <ImpactCard title="CO2 Offset" value={`${impactData.co2Offset} kg`} icon={Sprout} />
        </div>
      </section>
