...
export default function ReportPage(){
    ...
    const handleVerify = async () => {
        ...
        try{
            ...
            {   
                ...
                "quantity": "estimated qauntity with unit",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try{
            ...
            toast.success('Report submitted succesfully!')
        } catch(e){
            console.error('Error submitting report', e);
            toast.error('Failed to sunmit report. Please try again.');
        } finally{
    ...
    return (
        <div className="p-8 max-w-6xl text-gray-600 mx-auto">
        ...
        <Button type="button" onClick={handleVerify} className="w-full mb-8 bg-blue-600 hover:bg-blue-700 text-white py-3 text-lg rounded-xl transition-colors duration-300" disabled={!file || verificationStatus === 'verifying'}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
                <label htmlFor="location" className="text-sm block font-medium text-gray-700 mb-1">Location</label>
                {isLoaded ? (
            ...
            <div>
                ...
                onChange={handleInputChange}
                required
                className="w-full px-4 py-2 border border-gray-300 text-gray-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300 bg-gray-100"
        ...
        <div className='max-h-96 overflow-y-auto'>
            <table className='w-full '>
                ...
                <tbody className='divide-y divide-gray-200'>
                    {reports.map((report) => (
                        <tr key={report.id as any} className='hover:bg-gray-50 transition-colors duration-200'>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><MapPin className="inline-block w-4 h-4 mr-2 text-green-500" />{report.location}</td>
